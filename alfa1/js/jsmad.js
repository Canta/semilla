...
( function()
{
    ...
    MHD.prototype = {
        ...
        readFile : function()
        {
            ...
            var file = $(self.el.fileChooser)[0].files[0]
        ...
        usePlayer : function(player)
        {
            ...
            if (player.id3 || true) {
                ...
                console.debug(this.el.playPause);
